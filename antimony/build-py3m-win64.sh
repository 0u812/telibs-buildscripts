...
PYTHON=/c/Users/phantom/AppData/Local/Programs/Python/Python35/python.exe
PIP=/c/Users/phantom/AppData/Local/Programs/Python/Python35/Scripts/pip3.exe
PYINCLUDE="C:/Users/phantom/AppData/Local/Programs/Python/Python35/include"
GIT=git
CELLAPI=$ROOT/install/cell-api
LIBSBML=$ROOT/install/libsbml-experimental
ANTIMONY_INSTALL=$ROOT/install/antimony-trunk-py3m
...
mkdir -p $ROOT/build/antimony-trunk-py3m
cd $_
pwd
rm -rf *
...
echo "Now do something like twine upload -s --sign-with gpg2 -i 9BE0E97B  C:\Users\phantom\Documents\devel\install\antimony-trunk-py3m\bindings\python\dist\ ..."
