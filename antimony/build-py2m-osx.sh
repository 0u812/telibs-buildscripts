...
echo "Now do something like /Library/Frameworks/Python.framework/Versions/2.7/bin/twine upload -s --sign-with gpg2 -i 9BE0E97B /Users/phantom/devel/install/antimony-trunk-xcode-py2m/bindings/python/dist/ ..."
