...
export PYTHON_INCLUDE=$PYTHON_DIR/include/python3.6
...
mv $ROOT/install/$INSTNAME/lib/python3.6/site-packages/libsbml/libsbml.py $ROOT/install/$INSTNAME/lib/python3.6/site-packages/libsbml/__init__.py
