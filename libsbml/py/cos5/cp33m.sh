...
cp $THIS_DIR/__init__.py $ROOT/install/$INSTNAME/lib/python3.3/site-packages/libsbml

# fix dep libs
cp /usr/lib64/libbz2.so.1.0.3 $ROOT/install/$INSTNAME/lib/python3.3/site-packages/libsbml/libbz2.so.1
cp /usr/lib64/libxml2.so.2.6.26 $ROOT/install/$INSTNAME/lib/python3.3/site-packages/libsbml/libxml2.so.2
cp /lib64/libz.so.1.2.3 $ROOT/install/$INSTNAME/lib/python3.3/site-packages/libsbml/libz.so.1
patchelf --set-rpath '$ORIGIN/.' $ROOT/install/$INSTNAME/lib/python3.3/site-packages/libsbml/_libsbml.so
